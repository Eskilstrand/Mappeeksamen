...
Etter at testene er gjennomført kan vi se nærmere på hver forsøkperson sine data, ved T1. T1 er valgt da denne testen hadde flest deltakere. Dette gir muligheten til å se på hver enkelt forsøksperson om man finner dette interessant (@tbl-tbl1). 
...
### Korrelasjon mellom **$\dot{V}O_{2maks}$** og Wattmaks per kg

```{r}
#| code-fold: true
#| message: false
#| warning: false
#| fig-cap: "Hvert punkt = én observasjon"
